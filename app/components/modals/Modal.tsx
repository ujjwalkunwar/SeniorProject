 ...
 * @param {React.ReactElement} props.body - Body content of the modal.
 * @param {React.ReactElement} props.footer - Footer content of the modal.
 * @param {string} props.actionLabel - Label for the primary action button.
 * @param {boolean} props.disabled - Flag indicating whether the modal is disabled.
 * @param {Function} props.secondaryAction - Function for secondary action button.
